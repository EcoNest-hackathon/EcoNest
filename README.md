...
## 📋 Опис проєкту
EcoNest - це веб-платформа, присвячена модульним будинкам для переселенців, що постраждали від війни в Україні. Проєкт створено в рамках хакатону з метою забезпечення комфортним житлом тих, хто залишився без дому.
...
- ** Детальна інформація про моделі** - галерея, плани, характеристики
...
Детальніше в docs/ANALYTICS.md
...
- Salnikov Olexandr - Data Analyst / Video Production
...
- Компонентна архітектура з чіткою структурою файлів
